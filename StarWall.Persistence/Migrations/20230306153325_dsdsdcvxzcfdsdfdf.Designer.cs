...
namespace StarWall.Persistence.Migrations
{
    ...
    [Migration("20230306153325_dsdsdcvxzcfdsdfdf")]
    partial class dsdsdcvxzcfdsdfdf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StarWall.Domain.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDate = new DateTime(2023, 3, 6, 19, 3, 25, 309, DateTimeKind.Local).AddTicks(6742),
                            RoleId = 1,
                            Username = "Sahand"
                        });
                });
